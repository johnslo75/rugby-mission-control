...
export const TEAM_LOGOS: Record<string, string> = {
  // ── URC ──────────────────────────────────────────────────────────────────────
  "Leinster":           WP("Leinster_Rugby_logo.svg"),
  "Munster":            WP("Munster_Rugby_crest.svg"),
  "Ulster":             WP("Ulster_Rugby_crest.svg"),
  "Connacht":           WP("Connacht_Rugby_logo.svg"),
  "Glasgow Warriors":   WP("Glasgow_Warriors_logo.svg"),
  "Edinburgh Rugby":    WP("Edinburgh_Rugby_logo.svg"),
  "Scarlets":           WP("Scarlets_rugby_logo.svg"),
  "Cardiff Rugby":      WP("Cardiff_Rugby_logo.svg"),
  "Ospreys":            WP("Ospreys_rugby_logo.svg"),
  "Dragons RFC":        WP("Newport_Gwent_Dragons_logo.svg"),
  "Dragons":            WP("Newport_Gwent_Dragons_logo.svg"),
  "Stormers":           WP("DHL_Stormers_logo.svg"),
  "DHL Stormers":       WP("DHL_Stormers_logo.svg"),
  "Bulls":              WP("Blue_Bulls_logo.svg"),
  "Vodacom Bulls":      WP("Blue_Bulls_logo.svg"),
  "Sharks":             WP("The_Sharks_logo.svg"),
  "Cell C Sharks":      WP("The_Sharks_logo.svg"),
  "Lions":              WP("Lions_Rugby_Union_logo.svg"),
  "Emirates Lions":     WP("Lions_Rugby_Union_logo.svg"),
  "Benetton Rugby":     WP("Benetton_Rugby_logo.svg"),
  "Benetton":           WP("Benetton_Rugby_logo.svg"),
  "Zebre Parma":        WP("Zebre_Rugby_logo.svg"),
  "Zebre":              WP("Zebre_Rugby_logo.svg"),
