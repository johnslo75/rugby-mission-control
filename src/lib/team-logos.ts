...
export const TEAM_LOGOS: Record<string, string> = {
  ...
  "Lyon Olympique Universitaire":   WP("LOU_Rugby_logo.svg"),
  "Lyon":                           WP("LOU_Rugby_logo.svg"),
  "Section Paloise":                WP("Section_paloise_logo.svg"),
  "Pau":                            WP("Section_paloise_logo.svg"),
  "Union Bordeaux-Begles":          WP("Union_Bordeaux_Bègles_logo.svg"),
  "Union Bordeaux Bègle":          WP("Union_Bordeaux_Bègles_logo.svg"),
  "Bordeaux Bègle":                WP("Union_Bordeaux_Bègles_logo.svg"),
  "Aviron Bayonnais":               WP("Aviron_Bayonnais_logo.svg"),
  "Stade Francais Paris":           WP("Stade_Français_Paris_logo.svg"),
  "USA Perpignan":                  WP("USA_Perpignan_logo.svg"),
  "US Montauban":                   WP("US_Montauban_logo.svg"),
