...
export const TEAM_LOGOS: Record<string, string> = {
  ...
  "Bath Rugby":         WP("Bath_Rugby_logo.png"),
  "Bath":               WP("Bath_Rugby_logo.png"),
  "Bristol Bears":      WP("Bristol_Bears_logo.svg"),
  "Bristol":            WP("Bristol_Bears_logo.svg"),
  "Exeter Chiefs":      WP("Exeter_Chiefs_new_logo_2022.png"),
  "Exeter":             WP("Exeter_Chiefs_new_logo_2022.png"),
  "Gloucester Rugby":   WP("Gloucester_Rugby_logo.svg"),
  "Gloucester":         WP("Gloucester_Rugby_logo.svg"),
  "Harlequins":         WP("Harlequin_FC_logo.svg"),
  ...
  "Stade Rochelais":                WP("StadeRochelaisLogo.svg"),
  "La Rochelle":                    WP("StadeRochelaisLogo.svg"),
  "Racing 92":                      COM("Racing_92_(logo).svg"),
  ...
  "Bordeaux Begles":               WP("UnionBordeauxBeglesLogo.svg"),
  "Aviron Bayonnais":               WP("AvironBayonnaisLogo2022.svg"),
  "Bayonne":                        WP("AvironBayonnaisLogo2022.svg"),
